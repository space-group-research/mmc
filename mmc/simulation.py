...
from mmc.utils import BOLTZMANN, append_system, monte_carlo, gas_formation_energy, calculate_average_gas_distance
...
class Simulation(BaseModel):
    ...
    def simulate(self, steps: int, apply_energy_minimizer: bool) -> float:
        ...
        for timestep in range(steps):
            ...
            avg_distance = calculate_average_gas_distance(num_gases, positions_nm, self._mof_top.n_atoms, self._gas.n_atoms, self._pbc)
